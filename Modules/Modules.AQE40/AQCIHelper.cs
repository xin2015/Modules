...
namespace Modules.AQE40
{
    ...
    public class AQCIHelper
    {
        ...
        /// IAirData属性
        /// </summary>
        private static IPropertyAccessor[] IAirDataProperties;
        /// <summary>
        /// IAQCIReport单项质量指数属性
        /// </summary>
        private static Dictionary<string, IPropertyAccessor> IAQCIPropertiesDic;
        /// <summary>
        /// 污染物监测项浓度二级标准字典
        /// </summary>
        ...
        static AQCIHelper()
        {
            ...
            IAirDataProperties = typeof(IAirData).GetProperties().Select(o => factory.Get(o)).ToArray();
            ...
            IAQCIPropertiesDic = new Dictionary<string, IPropertyAccessor>();
            foreach (string pollutant in limitDic.Keys)
            {
                IAQCIPropertiesDic.Add(pollutant, factory.Get(IAQCIReportProperties.First(o => o.Name == string.Format("I{0}", pollutant))));
            }
        }
        ...
        private static Dictionary<string, decimal> GetIAQCIDic(IAQCICalculate data)
        {
            ...
            foreach (PropertyAccessor property in IAirDataProperties)
            {
                ...
                if (value != null)
                {
                    ...
                    if (decimalValue >= 0) IAQCIDic.Add(property.Property.Name, Math.Round(decimalValue / limitDic[property.Property.Name], 2));
                }
            }
            return IAQCIDic;
        }
