...
namespace Modules.AQE
{
    ...
    public class AQIHelper
    {
        ...
        /// IAQIReport分指数属性
        /// </summary>
        private static Dictionary<string, IPropertyAccessor> IAQIPropertiesDic;
        /// <summary>
        /// 对健康影响情况数组
        /// </summary>
        ...
        static AQIHelper()
        {
            ...
            IAQIPropertiesDic = new Dictionary<string, IPropertyAccessor>();
        ...
        private static Dictionary<string, int?> GetIAQIDic(IAirData data, Dictionary<string, int[]> concentrationLimitsDic)
        {
            ...
            foreach (PropertyAccessor property in IAirDataProperties)
            {
                ...
                if (value != null)
                {
                    IAQIDic.Add(property.Property.Name, GetIAQI(concentrationLimitsDic[property.Property.Name], (decimal)value));
                }
            }
            return IAQIDic;
        }
